...
export default function Storycard(){
    return <div className="w-5/6 bg-amber-300 h-auto rounded-3xl relative">
        ...
        <h3 className="lg:text-lg text-sm  text-center">“Thanks to GDG on campus I got 2 internship offers”</h3>
        <p className="text-xs text-right lg:text-center lg:text-base">-Amar Deep Rao</p>
        </div>
