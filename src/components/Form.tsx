...
export default function Form() {
  return (
    ...
    <form className=" md:gap-2 lg:w-2/3 md:grid md:w-4/5 md:m-auto md:grid-cols-3 md:grid-rows-6 items-center w-full p-2 flex flex-col">
        ...
        <input
        className='border-2 md:col-span-2  dark:bg-transparent dark:text-white  dark:border-gray-800 text-xl dark:bg-blue-500 bg-white rounded-lg m-2 p-1 text-black'
          id="frm-phone"
          type="number"
          name="phone"
        ...
        />
          ...
          <input
          className='border-2 dark:bg-transparent dark:text-white  dark:border-gray-800 text-xl md:col-span-2 bg-white rounded-lg m-2 p-1 text-black'
            id="frm-first"
            type="text"
            name="first"
          ...
          <input
          className='text-xl border-2 dark:bg-transparent dark:text-white  dark:border-gray-800 md:col-span-2 bg-white rounded-lg m-2 p-1 text-black'
            id="frm-last"
            type="text"
            name="last"
        ...
        <textarea className='dark:bg-transparent dark:text-white  dark:border-gray-800 text-xl md:h-20 border-2 md:col-span-2 md:row-span-2 bg-white rounded-lg m-2 p-1 text-black' id="frm-message" rows={6} name="message" placeholder='Enter your Suggetions/Complaints'></textarea>
