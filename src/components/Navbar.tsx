...
function Menu(){
    ...
    return<div className="lg:w-1/2 w-3/4 fixed lg:static object-center bottom-0 bg-red-10 dark:bg-black dark:bg-opacity-5 bg-opacity-50 backdrop-blur-lg bg-gray-200 lg:bg-transparent lg:bg-opacity-0 lg:backdrop-blur-none rounded-3xl  p-3 ">
