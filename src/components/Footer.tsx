...
export function Footer(){
    ...
    return<div className="bg-black md:rounded-3xl md:m-5 md:p-3">
        <div className="flex md:flex-row flex-col  items-center md:items-baseline">
        <div className="md:w-1/3 w-2/3 pt-4">
            <Image src={logo} alt="gdg-logo"/>
            <h3 className="text-gray-500 text-center">
            <i>on campus, BIET lucknow</i></h3>
        </div>
        <div className=" grid md:grid-cols-4 grid-cols-3 m-5 p-4 md:p-0 text-left gap-4 w-full ">
            <div className="md:col-start-2 text-gray-500 ">
        ...
        <div className=" w-24">
            <p className="font-bold text-lg text-gray-300">Socials</p>
            <div className="grid grid-cols-2">
                {/* Twitter */}
                <div className="w-10 h-10 fill-gray-500 flex justify-center items-center">
