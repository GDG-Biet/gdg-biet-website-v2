...
export default function Contacts(){
    ...
    return(
        <>
       <div className="mt-32 flex justify-center lg:w-[90%] bg-blue-500 m-auto lg:p-4 dark:bg-gray-900 dark:bg-opacity-50 backdrop-blur-lg rounded-xl relative">
        <Form></Form>
       </div>
       <div className="w-5/6 m-auto mt-20">
        ...
        <div className=" cursor-pointer p-20 flex justify-center items-center text-purple-600 hover:text-purple-400 bg-purple-400 hover:bg-purple-600 rounded-full my-10 duration-300">
            <p className="lg:text-5xl text-3xl text-center font-extrabold"><a href="mailto:bietgdsc2023@gmail.com">Send us a Mail</a></p>
            </div>
       </div>
       </>
    )
