    ...
    <div className="w-min-[1280px] mx-auto ">
      ...
      <div className="lg:h-[80vh] mb-20 pt-20 relative">
        ...
        <div className="flex justify-center gap-7 mt-10">
          <button className="p-2 font-semibold px-8 md:text-lg text-base border-2 border-black dark:border-gray-500 bg-[#4285F4] rounded-lg text-white ">
            Join Chapter
          </button>
          <button className="p-2 font-semibold px-8 md:text-lg  border-2 border-black dark:border-gray-500 text-[#4285F4] rounded-lg">
            Open Position
          </button>
        </div>
      </div>
      ...
      <div className="m-auto lg:mt-32 mt-10 sm:w-4/6 flex justify-center flex-col text-[#656C73]">
        <p className=" pl-10 text-xl font-semibold text-black dark:text-gray-500">
          We
        </p>
