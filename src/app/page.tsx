    ...
    <div className="w-min-[1280px] mx-auto">  
     ...
     <div><Image src={Circle} alt="Element-Square" className="lg:h-1/2 h-1/6 absolute lg:right-0 -right-16 top-[50vh] -z-0"/></div>
      ...
      <div className="w-full flex  justify-center mt-5">
        <h3 className="font-Lato text-black font-normal text-center mt-5 text-xl dark:text-white">On Campus<br/><strong className="text-[#FBBC04] mt-10 text-2xl leading-10">BIET</strong>, Lucknow</h3>
       </div>
      ...
      <div className="grid grid-cols-2 gap-5 w-11/12 m-auto">
        <div className="w-full h-100 rounded-xl bg-rose-300 bg-opacity-30">
